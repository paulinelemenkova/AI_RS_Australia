...
random forest (RF); (\textbf{b}) SVM; (\textbf{c})~decision tree classifier; (\textbf{d}) ANN-based MLP classifier. Image processing: author. %MDPI: The figure have incomplete content, please check if it affect reading, please replace it. Same as Figures 7-11 %Author: yes, correct. I have checked and revised all figures and content. The content is correct, the figures include legend and explanations in the text
}
  \label{fig06}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{tabular}
   \caption{Image processing for images from 2015 %Please ensure meaning has been retained. %Author: yes, retained.
   	using four methods: \textbf{(a)} RF; \textbf{(b)} SVM; \textbf{(c)} ANN-based MLPC; \textbf{(d)} DTC. Image source: author. %MDPI: The figure have incomplete content, please check if it affect reading, please replace it. %Author: I have checked and revised Figure 7 and its content. The content is correct, the figure includes legend and explanations in the text.
}
  \label{fig07}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{tabular}[b]{c}
    ...
    \small (\textbf{d}) 
  \end{tabular}
  \caption{\hl{Results} of image processing for images from 2017 %Please ensure meaning has been retained. %Author: yes, retained.
