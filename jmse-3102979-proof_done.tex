...
\address{%
$^{1}$ \quad Department of Geoinformatics, Faculty of Digital and Analytical Sciences, Paris Lodron Universität Salzburg, Schillerstraße 30, A-5020 Salzburg, Austria; \hl{polina.lemenkova@plus.ac.at or polina.lemenkova2@unibo.it;} %MDPI: Please check if the two email both should be kept.
 \linebreak Tel.: +43-677-6173-2772 or +39-344-69-28-732

$^{2}$ \quad Department of Biological, Geological and Environmental Sciences, Alma Mater Studiorum---Università di Bologna, Via Irnerio 42, \hl{IT-40126 Bologna,} %MDPI: Please check if the postcode format is correct, if it should be 40126.
 \hl{Emilia-Romagna,} %MDPI: Please confirm if region information can be removed.
 Italy
}
...
The research is focused on the {area} around Melbourne---the second largest city on the Australian continent---and~encompasses Port Phillip Bay. The~exact zone of the study area is {restricted between the coordinates} from 143°01$'$33.38$'$$'$ E to 143°08$'$03.62$'$$'$ E longitude and from 38°32$'$14.93$'$$'$ S to 36°24$'$10.94$'$$'$ S latitude{. This area} is located in the southern part of the state of Victoria, {Australia} {(}Figure \ref{fig01}{)}. 
 ...
 \begin{figure}[H]
    ...
    \caption{\hl{General} %MDPI: Please carefully check to make sure there are no Duplicate pictures throughout the text, thank you.
...
\caption{\hl{Metadata} %MDPI: We revised the table format, please confirm.
...
\newcolumntype{C}{>{\centering\arraybackslash}X}
 ...
 \begin{tabularx}{\textwidth}{LLLLL}
    \toprule
        ...
        Date Acquired & \hl{2024/03/29} %MDPI: Please check if the date format can be revised to the standard format, e.g., 29 March 2024, Please revised all in table.
 & 2017/03/18 & 2015/03/29 & 2013/03/26 \\ \midrule
        Roll Angle & 0.001 & 0.000 & 0.000 & 0.000 \\ \midrule
        Date Product Generated L2 & 2024/04/03 & 2020/09/04 & 2020/09/09 & 2020/09/13 \\ \midrule
        Date Product Generated L1 & 2024/03/29 & 2020/09/04 & 2020/09/09 & 2020/09/13 \\ \midrule
...
%\centering %% If there is a figure in wide page, please release command \centering
  ...
  \multirow{2}{*}{\textbf{Year}} & \multicolumn{6}{c}{\textbf{Parameters of Clustering}} \\
    ...
    \midrule
    \textbf{\hl{2013} %MDPI: Please confirm if the bold is unnecessary and can be removed. The following highlights are the same.
} & 7281 & 7421 & 54,032,301 & 7044 & 72 & 74 \\
    \textbf{\hl{2015}} & 7711 & 7661 & 59,073,971 & 7005 & 77 & 76 \\
    \textbf{\hl{2017}} & 7711 & 7652 & 59,004,572 & 7011 & 77 & 76 \\
    \textbf{\hl{2024}} & 7692 & 7522 & 57,859,224 & 7217 & 76 & 75 \\
\bottomrule
...
%MDPI: We moved the figure after the first citation, please confirm. same as all figures
...
\begin{table}[H]\renewcommand\arraystretch{1.2}
  \caption{Class distributions of the assigned target pixels' %Please ensure meaning has been retained. 
 ...
 \setlength{\tabcolsep}{3.42mm}
  ...
  \multirow{2}{*}{\textbf{Year}} & \multicolumn{10}{c}{\textbf{Classes of Land Cover Types}} \\
    ...
    \midrule
    \textbf{\hl{2013}} & 1183 & 425 & 482 & 493 & 446 & 588 & 744 & 773 & 752 & 1158 \\
    \textbf{\hl{2015}} & 1215 & 367 & 471 & 491 & 485 & 589 & 731 & 782 & 774 & 1100 \\
    \textbf{\hl{2017}} & 1146 & 415 & 496 & 414 & 464 & 634 & 738 & 887 & 812 & 1005 \\
    \textbf{\hl{2024}} & 1249 & 514 & 541 & 434 & 440 & 522 & 671 & 784 & 806 & 1256 \\
\bottomrule
\end{tabular}
...
\end{adjustwidth}
\caption{\hl{Class} %MDPI: We removed the equation label (1) and (2) in figures 12 and 13, please confirm.
 separability matrices for land cover classes: \textbf{{\hl{2013} %MDPI: Please confirm if the bold is unnecessary and can be removed. The following highlights are the same.
}} and \textbf{\hl{2015}}.}
\label{fig12}
\end{figure}
\vspace{-6pt}
...
\end{equation}
\end{adjustwidth}
\caption{Class separability matrices for land cover classes: \textbf{\hl{2017}} and \textbf{\hl{2024}}.}
\label{fig13}
\end{figure}
