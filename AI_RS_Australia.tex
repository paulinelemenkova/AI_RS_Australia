...
\bottomrule
\end{tabularx}
  \caption{Iterations process of pixels' assignment to target categories during image classification: 2013}
  \label{tabA1}
\end{table}
