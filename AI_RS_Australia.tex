...
\Title{Artificial Intelligence for Computational Remote Sensing: Quantifying Pattern Changes in Land Cover Types of the Cheetham Wetlands, Australia}

% MDPI internal command: Title for citation in the left column
\TitleCitation{Artificial Intelligence for Computational Remote Sensing: Quantifying Pattern Changes in Land Cover Types of the Cheetham Wetlands, Australia}
...
\address{%
$^{1}$ \quad Department of Geoinformatics, Faculty of Digital and Analytical Sciences, Paris Lodron Universität Salzburg (PLUS), Schillerstraße 30, A-5020 Salzburg, Austria.
