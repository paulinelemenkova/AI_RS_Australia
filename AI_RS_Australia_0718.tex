...
The technical tools applied in this study supported the advanced visualisation of the RS data for geospatial modelling and mapping of the coasts of southern Australia. All these approaches provided compelling evidence that environmental research using GIS and RS data is significantly elaborated compared to its beginning. \hl{Unlike the} traditional methods of mapping that are usually applied in RS data processing, the integrated approach which combines programming for satellite image processing and cartographic methods for visualization paves the way to the more advanced ways of handling Earth observation data. Specifically, \hl{it} combines programming and GIS \hl{which }is useful for mapping highly heterogeneous landscapes in \hl{the }coastal regions \hl{where} the mosaic vegetation pattern contrasts\hl{ }from the hinterland. 
