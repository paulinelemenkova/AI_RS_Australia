...
Novel methods and approaches arising in the rapidly developing ear of computing enable to overcome the issues of RS data processing. These include, for instance the use of general-purpose programming languages such as Python or R in cartographic applications, applications of Deep Learning (DL) \cite{Park,Roselin}, scripting techniques \cite{Lemenkova202212,Lemenkova202213} and algorithms of Artificial Intelligence (AI) \cite{rs11060617,Lemenkova202211}. The integration of RS data and these new technologies provides effective approach to  RS data handling for accurate and rapid image processing \cite{Turnbull,Lemenkova202323}. This presents a principally new cartographic approach for mapping marine and coastal environments through a powerful combination of Earth observation data and ML tools for effective monitoring of marine and coastal areas \cite{Cao2022}.
